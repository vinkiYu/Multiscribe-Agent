...
import { ArrowLeft, Blocks, BrainCircuit, CircleAlert, Files, LayoutDashboard, LibraryBig, ListChecks, Menu, Plus, RadioTower, RefreshCw, Search, Send, Settings2, Sparkles, Workflow, X } from 'lucide-react'
...
import { SourceSearchPage } from './pages/source-search'
import { TasksPage } from './pages/tasks'
import { WorkflowsPage } from './pages/workflows'

export type NavKey = 'dashboard' | 'operations' | 'sources' | 'source-search' | 'workflows' | 'content' | 'publishing' | 'tasks' | 'health' | 'knowledge' | 'memory' | 'plugins' | 'settings' | 'curation'
...
workbenchItems.push({ key: 'source-search', label: '数据源搜索', icon: Search })

copy['source-search'] = { title: '数据源搜索', description: '按关键词检索已采集内容，并查看高亮匹配片段。' }
