...
| P52-C | 设置页 UX 升级（Radix Switch + DropdownMenu：新建 shared/switch.tsx + shared/dropdown.tsx；迁移 8 个 checkbox-as-switch + 1 个手写 model catalog 多选下拉）| 🔄 进行中 | 任务包已就绪，待 Codex 执行；14 条验收；零行为变化 |
