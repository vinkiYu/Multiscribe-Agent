...
| P52-A | 策展质量运营页（消费 recharts + Radix Dialog：3 metric + 4 chart + 1 表格 + 1 Drawer + 1 个 archives×evaluations join 端点）| 🔄 进行中 | 任务包已就绪，待 Codex 执行；3 子任务 + 13 条验收；first chart consumer |
