...
| 功能 | 状态 |
|---|---|
| 🟡 GitHub Trending 采集 | 开发中 |
| 🟡 AI 搜索（Perplexity / Phind） | 开发中 |
| 🟡 微信公众号图文发布 | 开发中 |
| 🟡 小红书笔记发布 | 开发中 |
| 🟡 钉钉机器人推送 | 开发中 |
...
| 功能 | 计划版本 |
|---|---|
| 📋 知识库 RAG（sqlite-vec + FTS5 + RRF） | v0.2 |
| 📋 用户偏好记忆系统 | v0.2 |
| 📋 MCP 外部调用接口 | v0.3 |
| 📋 预置 Skill（技术周报 / 多源对比 / 智能推荐） | v0.3 |
...
| 项目 | 作用 |
|---|---|
| [PrismFlowAgent](https://github.com/yourusername/PrismFlowAgent) | TypeScript 原始实现，本项目的重构起点 |
